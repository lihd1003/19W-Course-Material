...
COPY country FROM 'E:/data/country.csv' DELIMITER ',' CSV header;
COPY party FROM 'E:/data/party.csv' DELIMITER ',' CSV header;
COPY cabinet FROM 'E:/data/cabinet.csv' DELIMITER ',' CSV header;
COPY election FROM 'E:/data/election.csv' DELIMITER ',' CSV header;
COPY cabinet_party FROM 'E:/data/cabinet_party.csv' DELIMITER ',' CSV header;
COPY election_result FROM 'E:/data/election_result.csv' DELIMITER ',' CSV header;
COPY party_position FROM 'E:/data/party_position.csv' DELIMITER ',' CSV header;
COPY party_family FROM 'E:/data/party_family.csv' DELIMITER ',' CSV header;
COPY politician_president FROM 'E:/data/politician_president.csv' DELIMITER ',' CSV header;
